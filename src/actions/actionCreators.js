...
export function fetchServiceRequest (id) {
  return {type: FETCH_SERVICES_REQUEST, payload: {id} };
}
...
export function fetchServiceSuccess(data) {
  return {type: FETCH_SERVICES_SUCCESS, payload: {data}}
}
